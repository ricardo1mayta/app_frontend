...
@Component({
  selector: 'app-contizacion',
  templateUrl: './contizacion.component.html',
  styleUrls: ['./contizacion.component.css'],
})
export class ContizacionComponent implements OnInit {
  ...
  serieComprobante: tDoc[] = [
    { value: 'CO01', viewValue: 'CO01' },
    { value: 'CO02', viewValue: 'CO02' },
  ];
  tipoDoc: tDoc[] = [
  ...
  constructor(
    ...
    private pedidosService: CotizacionesService,
    ...
    if (this.form.valid) {
      ...
      this.pedidosService
        ...
        .subscribe((res) => {
          this.loading = false;
          this.bntblok = true;
          this.router.navigate(['./admin/contizaciones']);
        });
    } else {
      this.loading = false;
