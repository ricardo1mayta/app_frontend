...
import { Inventario } from '../../../core/models/invetario.model';
interface tDoc {
  value: string;
  viewValue: string;
}
...
export class ProductsListComponent implements OnInit {
  ...
  fetchUsers() {
    ...
    this.productoService
      .getAllProductos(this.page, this.pageSize)
      .subscribe((partida) => {
        //  this.partida = partida;

        const data: Factura[] = Object.values(partida)[0];
        this.productos = data;
        const data2: Inventario[] = Object.values(partida)[0];
        this.productos = data;
        this.inventario = data2;
  ...
  invetario(): void {
    this.excelService.exportAsExcelFile(this.inventario, 'Inventario');
  }
}
